 ...
 * actually checked. Four answers, from weakest to strongest:
 *
 ...
 */
export const STAT_SOURCES = ['self_reported', 'imported', 'proof', 'platform'] as const;
