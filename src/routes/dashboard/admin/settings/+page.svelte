...
<div class="mx-auto max-w-2xl space-y-6">
	...
	<div class="bento-card bento-card-static">
		<form method="POST" action="?/save" use:enhance enctype="multipart/form-data" class="space-y-2">
			...
			<!-- The headline, hero picture and section order live on their own screen. -->
			<a
				href={resolve('/dashboard/admin/landing')}
				class="flex items-center gap-1.5 pt-1 text-[11px] font-black text-brand-soft-fg underline underline-offset-2"
			>
