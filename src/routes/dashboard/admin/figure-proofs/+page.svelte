		...
		<div class="flex flex-wrap items-center gap-2">
			{#each tabs as tab (tab.key)}
				<a
					...
					class="inline-flex min-h-9 cursor-pointer items-center rounded-xl border-2 border-edge px-3 py-1.5 text-xs font-black shadow-[2px_2px_0px_0px_rgb(var(--bento-shadow))] transition-all sm:min-h-0 {statusFilter ===
					tab.key
